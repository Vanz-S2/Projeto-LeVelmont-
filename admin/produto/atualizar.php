        ...
        <div class="nome-exercicio">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="precoProduto" id="precoProduto" onkeyup="adicionarReal();" onkeypress="isNumber(event);" onkeypress="proibirLetras(event);" placeholder="R$00,00" value="<?php echo $produto->precoProduto ?>">
