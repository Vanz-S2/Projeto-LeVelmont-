...
<div class="table_responsive">
    ...
    <div class="pesquisa">
        ...
        <select class="statusProduto" id="statusProduto" onchange="filtrarTabela()">
        ...
        <tbody>
            ...
            <?php foreach ($lista as $linha) : ?>
                ...
                <tr>
                    ...
                    <td>
                        <a class="icon-link icon-link-hover atualizar" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=produto&po=atualizar&id=<?php echo $linha['idProduto'] ?>">
                    ...
                    <td><a class="icon-link icon-link-hover desativar" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=produto&po=desativar&id=<?php echo $linha['idProduto'] ?>" onclick="return confirmarDesativacao()">
