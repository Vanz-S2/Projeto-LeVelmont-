...
<div class="table_responsive">
    <h2 class="info-lista"> Lista de Alunos </h2>
        ...
        <tbody>
            <?php foreach ($lista as $linha): ?>
                ...
                <tr>
                    ...
                    <th>
                        <?php echo $linha['dataCadAluno'] ?>
                    </th>

                    <th>
                        <?php echo $linha['statusAluno'] ?>
                    </th>
